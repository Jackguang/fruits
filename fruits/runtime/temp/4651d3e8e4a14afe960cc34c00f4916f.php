<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\phpStudy\WWW\frit\fruits\public/../application/home\view\user\user.html";i:1492657113;}*/ ?>
<!DOCTYPE html>
<html class="no-js">
<head>
  <meta charset="UTF-8">
		...
		<section class="m-component-user" id="m-user">
	        ...
	        <div class="head_list">
	        	<ul class="m-user-list">
	        		...
	        		<li><a href="coupon.html"><span class="bar"></span><span>4</span><br>会员等级</a></li>
	        ...
	        <ul class="m-user-content">
	            ...
	            <li>
	            	<div class="m-user-item">
	                   <a href="/user/coupon" class="user-site">管理收货地址</a>
	                </div>
	                <div class="m-user-item">
