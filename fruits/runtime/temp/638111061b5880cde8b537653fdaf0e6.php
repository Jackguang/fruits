<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"E:\phpStudy\WWW\frit\fruits\public/../application/index\view\hard\reply_list.html";i:1492225574;s:72:"E:\phpStudy\WWW\frit\fruits\public/../application/index\view\layout.html";i:1492483054;s:23:"./index/layout/top.html";i:1492403485;s:24:"./index/layout/left.html";i:1492607197;s:26:"./index/layout/footer.html";i:1492173983;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                ...
                <div class="table-responsive">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td> <h3><?php echo date("y-m-d H:i:s",$vo['reply_time']); ?></h3></td>
                            <td> <span style="color: red"><h3><?php echo $vo['a_name']; ?></h3></span></td>
                            <td> <h3>回复给：</h3></td>
                            <td> <span style="color: green"><h3><?php echo $vo['u_name']; ?></h3></span></td>
                            <!--<td> <?php echo $vo['opinion_id']; ?></td>-->
                            <td> <h3><?php echo date("y-m-d H:i:s",$vo['opinion_time']); ?></h3></td>
                            <td>
                                <a href="<?php echo url('hard/reply_details'); ?>?sg_opinion=<?php echo $vo['opinion_id']; ?>"><button class="btn">查看意见</button></a>
                                <a href="<?php echo url('hard/reply_details'); ?>?sg_reply=<?php echo $vo['reply_id']; ?>"><button class="btn btn-danger">查看回复</button></a>
                            </td>
                        </tr>
