...
<div class="main-content">
    ...
    <h2 style="margin-left: 50px;">意见内容:</h2>
        <div style="width: 500px;height: 500px; margin-left: 150px; float: left">
            <font style="font-size: 20px;">
                <br><br>
                <?php echo str_repeat('&nbsp;','10');?><?php echo $arr['opinion_content']; ?>
            </font>
        </div>
    ...
    <div style="float: left; margin-left: 120px;">
        <form action="<?php echo url('index/hard/reply'); ?>" method="post">
            <input type="hidden" value="<?php echo $arr['opinion_id']; ?>" name="o_id">
        <textarea style="background: lightgrey; font-size: 20px;" rows="10" cols="80" name="content"></textarea>
        <br><br><input type="submit" value="回复" style="width: 120px; height: 80px; float: right"> </form></div>
