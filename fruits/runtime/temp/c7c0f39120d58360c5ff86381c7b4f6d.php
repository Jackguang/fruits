<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\WAPM\WWW\chenyan\11\fruits\fruits\public/../application/home\view\activty\act_show.html";i:1493123003;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<?php endforeach; endif; else: echo "" ;endif; ?><br><br><br><div class="footer navbar-fixed-bottom">
    <div class="row">
        ...
        <div class="col-xs-3  text-center" style="padding-top:5px;">
            <a class="cgray" href="<?php echo url('home/userinfo/index'); ?>"><div class="photo_30"><img src="home/images/nav4.png"><br>我的</div></a>
        </div>
    </div>
</div>
