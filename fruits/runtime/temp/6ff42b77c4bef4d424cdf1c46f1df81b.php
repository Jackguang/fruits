<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"E:\phpStudy\WWW\fruits\fruits\public/../application/index\view\order\show.html";i:1493187439;s:74:"E:\phpStudy\WWW\fruits\fruits\public/../application/index\view\layout.html";i:1493005028;s:23:"./index/layout/top.html";i:1493005030;s:24:"./index/layout/left.html";i:1493197143;s:26:"./index/layout/footer.html";i:1493005030;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
	...
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			<li>
				...
				<a href="<?php echo url('index/index/show'); ?>">首页</a>
			</li>
...
取货方式：<input type="text" id="type">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="table-responsive">
					...
					<tbody id="tbody">
					<?php if(is_array($order_list) || $order_list instanceof \think\Collection): if( count($order_list)==0 ) : echo "" ;else: foreach($order_list as $key=>$v): ?>							
						<tr>
							<td class="center">
								<label>
									<input type="checkbox" class="ace" />
							...
							<td><?php echo $v['sg_fruitsname']; ?></td>
							<td><?php echo $v['o_num']; ?></td>
							<td><?php echo $v['o_price']; ?></td>
							<td><?php echo $v['a_address']; ?></td>
							<td><?php echo $v['o_time']; ?></td>
							<td><?php echo $v['o_type']; ?></td>
	...
	//搜索   分页
	   ...
	   function page(p){
	       ...
	       $.ajax({
	           type: "GET",
	           url: "<?php echo url('index/Order/ajaxs'); ?>",
	           data: 'p='+p+str,
	           dataType:'json',
