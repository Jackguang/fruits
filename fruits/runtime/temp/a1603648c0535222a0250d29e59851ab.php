<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\WAPM\WWW\chenyan\11\fruits\fruits\public/../application/home\view\cart\unpaid.html";i:1493276340;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <section class="order">
        ...
        <dl class="n<?php echo $va['o_id']; ?>">
            ...
            <dd >
                ...
                <?php endif; ?>
                <input type="button" value="我要付款"  class="fu"  alt="<?php echo $va['o_id']; ?>" style="background-color: red;width: 75px;height: 30px;"/>
                <input type="button" value="取消订单"  class="qu"  alt="<?php echo $va['o_id']; ?>" style="background-color: red;width: 75px;height: 30px;"/>
...
<script>
    //取消订单
    $('.qu').click(function(){
        var oid=$(this).attr('alt');//获取订单id
        $.ajax({
            type: "POST",
            url: "<?php echo url('index.php/home/Cart/qu'); ?>",
            data: "o_id="+oid,
            dataType:'json',
